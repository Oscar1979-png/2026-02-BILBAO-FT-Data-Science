...
import sqlite3              ## escribe y lee libros de una BD squilite
...
def get_all():
    connection = sqlite3.connect('books.db')        ## se conecta a la BD
...
def filter_table():
    ...
    query = query[:-4] + ';'            ## para concatenar y quitar un AND
