...
- **Basadas en Grafos:** Usa una estructura de grafos para almacenar información y sus relaciones.  ##en redes sociales
...
- **vectoriales:** ##recogen vectores y su relación entre ellos.
...
Redis es una base de datos de clave-valor. Redis puede ser usada para almacenar y recuperar información a una velocidad extremadamente alta. Eso lo hace popular en aplicaciones como la caché de datos.     ##memoria RAM. Es muy rapida
